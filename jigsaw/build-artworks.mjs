...
const jigsawDir = path.join(root, "jigsaw");
const imageDir = path.join(jigsawDir, "artworks");
const metaPath = path.join(jigsawDir, "artworks-meta.json");
const outputPath = path.join(jigsawDir, "artworks.json");
const baseUrl = "https://healingmart.github.io/hm-mini-game-dist/jigsaw/artworks/";
...
console.log(`jigsaw/artworks.json 생성 완료: ${artworks.length}개`);
